                    ...
                    {(profile.social_instagram||profile.social_tiktok||profile.social_url||profile.contact_email)&&(
                      <div className="flex flex-wrap gap-2 mb-6">
                        {profile.social_instagram&&(
                          <a href={`https://instagram.com/${profile.social_instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer" style={{fontFamily:'Bebas Neue, sans-serif',borderColor:'#E1306C',color:'#E1306C',textDecoration:'none',backgroundColor:'transparent'}} className="flex items-center gap-1.5 px-3 py-1.5 text-[9px] tracking-[0.2em] font-black border transition-all hover:opacity-70">
                        ...
                        {profile.social_tiktok&&(
                          <a href={`https://tiktok.com/@${profile.social_tiktok.replace('@','')}`} target="_blank" rel="noopener noreferrer" style={{fontFamily:'Bebas Neue, sans-serif',borderColor:'#69C9D0',color:'#69C9D0',textDecoration:'none',backgroundColor:'transparent'}} className="flex items-center gap-1.5 px-3 py-1.5 text-[9px] tracking-[0.2em] font-black border transition-all hover:opacity-70">
                        ...
                        {profile.social_url&&(
                          <a href={profile.social_url.startsWith('http')?profile.social_url:`https://${profile.social_url}`} target="_blank" rel="noopener noreferrer" style={{fontFamily:'Bebas Neue, sans-serif',borderColor:T.accent,color:T.accent,textDecoration:'none',backgroundColor:'transparent'}} className="flex items-center gap-1.5 px-3 py-1.5 text-[9px] tracking-[0.2em] font-black border transition-all hover:opacity-70">
                        ...
                        {profile.contact_email&&(
                          <a href={`mailto:${profile.contact_email}`} style={{fontFamily:'Bebas Neue, sans-serif',borderColor:T.accent,color:T.accentText,textDecoration:'none',backgroundColor:T.accent}} className="flex items-center gap-2 px-4 py-2 text-[9px] tracking-[0.25em] font-black transition-all hover:opacity-80">
