    ...
    return (
      <>
        ...
        <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #f8f8f6 0%, #fff 50%, #f5f5f8 100%)", fontFamily: "DM Sans, sans-serif" }}>
          {/* Top nav bar */}
          <div style={{ padding: "20px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "80px 32px 120px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>

              {/* Left — copy */}
              <div>
                <div className="fade-1" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#000", color: "#fff", padding: "6px 14px", borderRadius: "100px", fontSize: "11px", fontWeight: 600, letterSpacing: "0.08em", marginBottom: "28px" }}>
                  <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><circle cx="5" cy="5" r="5" fill="#4ade80"/></svg>
                  CREATOR PROGRAM
                </div>

                <h1 className="fade-2" style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: "clamp(40px, 5vw, 58px)", lineHeight: 1.05, letterSpacing: "-0.03em", margin: "0 0 20px", color: "#0a0a0a" }}>
                  Unlock your<br />
                  <span className="shimmer-text">creator tools.</span>
                </h1>

                <p className="fade-3" style={{ fontSize: "16px", color: "#666", lineHeight: 1.7, margin: "0 0 40px", fontWeight: 400 }}>
                ...
                <div className="fade-4">
                  {hasApplied ? (
                    <div style={{ display: "inline-flex", flexDirection: "column", background: "#f5f5f5", borderRadius: "16px", padding: "20px 28px", gap: "6px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <div style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#f59e0b" }} />
                        <span style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "14px", color: "#0a0a0a" }}>Application under review</span>
                      </div>
                      <p style={{ margin: 0, fontSize: "13px", color: "#888", paddingLeft: "18px" }}>We'll reach out once we've reviewed your profile.</p>
                    </div>
                  ) : (
                    <button
                      className="apply-btn"
                      ...
                      disabled={applying}
                      style={{ background: "#0a0a0a", color: "#fff", border: "none", borderRadius: "14px", padding: "18px 36px", fontSize: "15px", fontWeight: 600, fontFamily: "DM Sans, sans-serif", cursor: applying ? "not-allowed" : "pointer", opacity: applying ? 0.6 : 1, letterSpacing: "-0.01em" }}
                    >
                ...
                <p className="fade-5" style={{ fontSize: "12px", color: "#aaa", marginTop: "16px" }}>
                  Free to apply · Reviewed within 48 hours
                </p>
              </div>

              {/* Right — visual benefit cards */}
              <div className="fade-3" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>

                <div className="benefit-card card-float" style={{ background: "#fff", borderRadius: "20px", padding: "28px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)", border: "1px solid rgba(0,0,0,0.06)", display: "flex", gap: "20px", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <p style={{ margin: "0 0 6px", fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "16px", color: "#0a0a0a" }}>Real-time analytics</p>
                    <p style={{ margin: 0, fontSize: "13px", color: "#888", lineHeight: 1.6 }}>Track every click, like, and bookmark across all your catalogs and items.</p>
                  </div>
                </div>

                <div className="benefit-card card-float-2" style={{ background: "#fff", borderRadius: "20px", padding: "28px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)", border: "1px solid rgba(0,0,0,0.06)", display: "flex", gap: "20px", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <p style={{ margin: "0 0 6px", fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "16px", color: "#0a0a0a" }}>Verified badge</p>
                    <p style={{ margin: 0, fontSize: "13px", color: "#888", lineHeight: 1.6 }}>Stand out on the platform with a badge that signals trust and authenticity.</p>
                  </div>
                </div>

                <div className="benefit-card card-float-3" style={{ background: "#fff", borderRadius: "20px", padding: "28px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)", border: "1px solid rgba(0,0,0,0.06)", display: "flex", gap: "20px", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <p style={{ margin: "0 0 6px", fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "16px", color: "#0a0a0a" }}>Performance insights</p>
                    <p style={{ margin: 0, fontSize: "13px", color: "#888", lineHeight: 1.6 }}>See which items resonate most and optimize your catalogs for engagement.</p>
                  </div>
                </div>
    ...
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#fafafa", fontFamily: "DM Sans, sans-serif", color: "#0a0a0a" }}>
        ...
        <div style={{ display: "flex", minHeight: "100vh" }}>
          ...
          {/* Sidebar */}
          <aside style={{ width: "220px", background: "#fff", borderRight: "1px solid rgba(0,0,0,0.08)", padding: "28px 20px", flexShrink: 0, position: "sticky", top: 0, height: "100vh", display: "flex", flexDirection: "column", gap: "4px" }}>
